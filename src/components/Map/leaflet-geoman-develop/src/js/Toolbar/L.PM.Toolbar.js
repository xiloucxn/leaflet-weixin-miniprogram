...
const Toolbar = L.Class.extend({
  ...
  init(map) {
    ...
    this.highEditContainer = L.DomUtil.create(
      'div',
      'leaflet-pm-toolbar leaflet-pm-highEdit leaflet-bar leaflet-control'
    );
  ...
  applyIconStyle() {
    ...
    const iconClasses = {
      geomanIcons: {
        ...
        unionPolygon: 'control-icon leaflet-pm-icon-union',
  ...
  _defineButtons() {
    ...
    this._addButton('unionPolygon', new L.Control.PMButton(unionButton));

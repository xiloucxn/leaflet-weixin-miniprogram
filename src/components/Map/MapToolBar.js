...
function MapToolBar({
  ...
  useEffect(() => {
    ...
    emitter.addListener("setqyjgChecked", (v) => {
    ...
    return () => {
      ...
      emitter.removeAllListeners("setqyjgChecked");
  ...
  const [baseLayersDropdownVisible, setBaseLayersDropdownVisible] =
    useState(false);
  const [overlayDropdownVisible, setOverlayDropdownVisible] = useState(false);
  const [toolDropdownVisible, setToolDropdownVisible] = useState(false);
    ...
    <div style={style}>
      ...
      >
        <Dropdown
          ...
          onVisibleChange={(e) => {
            setOverlayDropdownVisible(e);
          }}
          visible={overlayDropdownVisible}
        >
        ...
        <Dropdown
          ...
          onVisibleChange={(e) => {
            setBaseLayersDropdownVisible(e);
          }}
          visible={baseLayersDropdownVisible}
        >
          <div style={{ padding: "0 15px" }}>
            <span style={{ marginRight: 5 }}>
              <GlobalOutlined />
        ...
        <Dropdown
              ...
              <Tooltip title={`显示、隐藏统计图`}>
                <Switch
                  ...
                  onClick={(v, e) => {
                    ...
                    // console.log(v)
                    // if (v === true) {
                    //   this.setState({ autoShowChart: true });
                    //   setTimeout(() => {
                    //     me.isShowChart = true;
                    //     //绘制统计图
                    ...
                    //   }, 300);
                    // } else {
                    //   this.setState({ autoShowChart: false });
                    //   me.isShowChart = false;
                    //   me.allEchartLayers.forEach((item) => {
                    //     item.clearLayers();
                    //   });
                    //   //隐藏统计图表123
                    //   me.setState({ showChartLeft: false, showChartRight: false });
                    // }
                  }}
                />
              </Tooltip>
          ...
          onVisibleChange={(e) => {
            setToolDropdownVisible(e);
          }}
          visible={toolDropdownVisible}
        >
          <div style={{ padding: "0 15px" }}>
            <span style={{ marginRight: 5 }}>
              <ToolOutlined />

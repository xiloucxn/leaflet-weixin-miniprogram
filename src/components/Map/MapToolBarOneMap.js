...
function MapToolBarOneMap({
  ...
  useEffect(() => {
    ...
    emitter.addListener("setonemapChecked", (v) => {
    ...
    return () => {
      ...
      emitter.removeAllListeners("setonemapChecked");
          ...
          overlay={
            ...
            >
              ...
              <Tooltip title={`显示、隐藏统计图`}>
                <Switch
                  style={{ width: 80, left: 15, marginBottom: 10 }}
                  checkedChildren="统计图"
      ...
      <div id="maptool-content" style={{ marginTop: 10 }}>
        {
          ...
          >
            <Card
              ...
              style={{ width: 300 }}
            >
              {currentTool === "图例" && <img src="./img/一张图图例.png"></img>}
              {
                <div
                  id="measure"
                  style={{
